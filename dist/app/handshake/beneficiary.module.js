...
const handshake_controller_1 = require("./handshake.controller");
...
exports.BeneficiaryModule = BeneficiaryModule = __decorate([
    (0, common_1.Module)({
        controllers: [handshake_controller_1.BeneficiaryController],
        providers: [handshake_service_1.BeneficiaryService, prisma_service_1.PrismaService],
    })
], BeneficiaryModule);
