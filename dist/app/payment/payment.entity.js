...
exports.GetResPopularCorridors = exports.GetResFxRate = exports.BaseResponseEncryptPayload = exports.EncryptedPayloadResponse = exports.EncryptPayload = exports.BaseResPopularCorridor = exports.BaseResFxRate = exports.Payment = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'qwertyuiopcvbnm56y7u8i90nmtyhujiklovbnm' }),
    __metadata("design:type", String)
], EncryptPayload.prototype, "data", void 0);
class EncryptedPayloadResponse {
}
exports.EncryptedPayloadResponse = EncryptedPayloadResponse;
__decorate([
    (0, swagger_1.ApiProperty)({ type: EncryptPayload }),
    __metadata("design:type", EncryptPayload)
], EncryptedPayloadResponse.prototype, "encrypted_payload", void 0);
class BaseResponseEncryptPayload extends utils_1.BaseResponse {
}
exports.BaseResponseEncryptPayload = BaseResponseEncryptPayload;
__decorate([
    (0, swagger_1.ApiProperty)({
        type: EncryptedPayloadResponse,
    }),
    __metadata("design:type", EncryptedPayloadResponse)
], BaseResponseEncryptPayload.prototype, "result", void 0);
