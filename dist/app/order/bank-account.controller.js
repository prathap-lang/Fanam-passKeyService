...
let BankAccountController = class BankAccountController {
    ...
    async myBankAccounts(user) {
        const result = await this.bankService.myAccounts(user);
        return new utils_1.AppResponse(result, 'Fetch My Bank-accounts Successfully');
    }
    ...
    async senderBankAccountDetail(account_id) {
        const result = await this.bankService.senderBankAccountDetail(account_id);
        return new utils_1.AppResponse(result, 'Fetched Bank-account Successfully');
    }
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get my Bank-accounts' }),
    (0, swagger_1.ApiOkResponse)({ type: bank_account_entity_1.EntityGetBankAccountList }),
    (0, common_1.Get)('my-bank-accounts'),
    __param(0, (0, decorators_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_entity_1.BaseResUser]),
    __metadata("design:returntype", Promise)
], BankAccountController.prototype, "myBankAccounts", null);
__decorate([
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get sender Bank-account' }),
    (0, swagger_1.ApiOkResponse)({ type: bank_account_entity_1.EntityGetBankAccount }),
    (0, common_1.Get)(':account_id/sender'),
    __param(0, (0, common_1.Param)('account_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], BankAccountController.prototype, "senderBankAccountDetail", null);
__decorate([
