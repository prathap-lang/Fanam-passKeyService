...
import { AccountType, AppResponse } from 'utils';
...
export declare class RecipientController {
    ...
    create(body: CreateRecipientDto, user: BaseResUser): Promise<AppResponse<{
        country: {
            country_id: number;
            country_name: string;
            iso3: string;
    ...
    findAll(recipient_type: AccountType, user: BaseResUser): Promise<AppResponse<({
        country: {
            country_id: number;
            country_name: string;
            iso3: string;
    ...
    findOne(recipient_id: string, user: BaseResUser): Promise<AppResponse<{
        country: {
            country_id: number;
            country_name: string;
            iso3: string;
    ...
    update(recipient_id: string, updateRecipientDto: UpdateRecipientDto, user: BaseResUser): Promise<AppResponse<{
        country: {
            country_id: number;
            country_name: string;
            iso3: string;
